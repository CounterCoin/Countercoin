...
const QString BITCOIN_IPC_PREFIX("Countercoin:");
...
{
    QString name("CountercoinQt");

    // Append a sCSGOle hash of the datadir
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Countercoin: click-to-pay handler");
    else
